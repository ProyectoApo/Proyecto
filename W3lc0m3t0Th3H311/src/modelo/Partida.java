...
//		}
	...
	// Este m�todo sirve para ordenar el ArrayList de Jugadores registrados, con el
	// orden natural de la clase Jugador, que en este caso es ordenando
	// segun el puntaje del jugador. (Utilic� el m�todo de ordenamiento por
	// seleccion)
	...
	// Este m�todo permite organizar los jugadores registrados en orden alfabetico.
	// (Orden parcial utilizando el m�todo de ordenamiento por insercion)
	...
	// Este m�todo permite buscar a un jugador por su puntaje, utilizando la
	// b�squeda binaria.
